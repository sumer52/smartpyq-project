  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className={`absolute top-20 left-20 w-64 h-64 bg-gradient-to-r ${config.gradient} rounded-full filter blur-xl animate-pulse`} />
        <div className={`absolute bottom-20 right-20 w-48 h-48 bg-gradient-to-r ${config.gradient} rounded-full filter blur-xl animate-pulse`} style={{ animationDelay: '1s' }} />
      </div>
      ...
      >
        ...
        >
          ...
          <Link to="/contact" className="btn btn-ghost btn-lg font-semibold">
            Contact Support
          </Link>
        </motion.div>
      </motion.div>
