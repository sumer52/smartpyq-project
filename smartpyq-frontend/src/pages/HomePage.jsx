      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-400">Five ways to prepare smarter — not just harder</p>
          </motion.div>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-400">Upload a paper — AI reveals repeated questions, topic frequency, and exam patterns</p>
          </motion.div>
